        ...
        <Grid item xs={12} sm={6} container spacing={4} sx={{ mt: 1 }}>
          <Grid item xs={6}>
            <Field
              ...
              name="currentPinCode"
              label="Pin Code"
              error={touched.currentPinCode && Boolean(errors.currentPinCode)}
              helperText={touched.currentPinCode && errors.currentPinCode}
              disabled={!isEditMode}
              InputLabelProps={{
                style: {
                  color: "black",
                    ...
                    <IconButton
                      ...
                      onClick={() =>
                        setFieldValue(
                          ...
                          Math.max(values.currentYearsInResidence - 1, 0)
                        )
                      }
                      disabled={!isEditMode}
                      sx={{ color: "#555555" }}
